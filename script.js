//import { king_icon, queen_icon, knight_icon, pawn_icon, rook_icon, bishop_icon } from "./icon_markup";
const pawn_icon = `<svg fill="#000000" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
const knight_icon = `<svg fill="#000000" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 viewBox="0 0 512 512" xml:space="preserve">
<g>
	<g>
...
const queen_icon = `<svg fill="#000000" height="800px" width="800px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
const rook_icon = `<svg width="800px" height="800px" viewBox="-10 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
...
const king_icon = `<svg fill="#000000" height="800px" width="800px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
const bishop_icon = `<svg fill="#000000" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
function cleanUpBoard(valid, row, col) {
  ...
  if (next_moves) {
    while (next_moves.length !== 0) {
      const temp = next_moves.pop();
      if (temp.node.capture) console.log(temp);
      temp.node.classList.remove("active");
      temp.node.classList.remove("capture");
    }
  }
...
function renderPiece(row, col, obj) {
  const start_point = cells.get(`${row},${col}`);
  const children = start_point.children;
  if (children.length !== 0) {
    start_point.removeChild(children[0]);
...
function action(row, col) {
  for (let i = 0; i < next_moves.length; i++) {
    const next_row = next_moves[i].next_row;
    const next_col = next_moves[i].next_col;
