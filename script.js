...
const king = new King("king", "white", 4, 4);
tracker[4][4] = king;

const king1 = new King("king", "white", 7, 5);
tracker[7][5] = king1;
...
for (let i = 0; i < 8; i++) {
  for (let j = 0; j < 8; j++) {
    if (tracker[i][j]) {
      ...
      img.className = "piece";
      img.innerHTML = `<svg fill="#000000" height="800px" width="800px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 viewBox="0 0 290 290" xml:space="preserve">
<g>
	<path id="rect28941" d="M145,20c-13.748,0-25,11.252-25,25c0,10.751,6.882,19.976,16.457,23.486l-62.496,89.279l-38.916-31.133
		C43.828,122.745,50,113.939,50,103.76c0-13.748-11.252-25-25-25s-25,11.252-25,25c0,12.037,8.626,22.161,20,24.494V265
